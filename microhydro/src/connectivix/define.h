#ifndef CONNECTIVIX_DEFINE_H_
#define CONNECTIVIX_DEFINE_H_
...
#define PWARP 4
#define PWARP_ROWS 128 // 256
#define PWARP_TSIZE 32
#define PWARP_BLOCK_SIZE (PWARP * PWARP_ROWS)

#define NUMERIC_PWARP 4
#define NUMERIC_PWARP_ROWS 64 // 128
#define NUMERIC_PWARP_TSIZE 48
...
#define THRUST_EXEC_POLICY thrust::device
// #define THRUST_EXEC_POLICY thrust::host
